...
# 
# - Input Parameters:
#      PARAM_y  : SQL query producing the y parameter of L_Regress_Federation
#      PARAM_A : SQL query producing the A parameter of L_Regress_Federation
# - Execution context:
...
res <- LRegress_Federation(y, A)

# Store results in the database
dbSendUpdate(conn, "INSERT INTO federation_results_linear_regression(request_id, param_y, param_a, result_betai, result_sigmai) VALUES (?, ?, ?, ?, ?)",
