...
lsof -i :14400 > /dev/null || ssh -f ludovic@hbps2.intranet.chuv -L 14400:hbps2.intranet.chuv:4400 -N
lsof -i :24400 > /dev/null || ssh -f ludovic@hbps3.intranet.chuv -L 24400:hbps3.intranet.chuv:4400 -N
